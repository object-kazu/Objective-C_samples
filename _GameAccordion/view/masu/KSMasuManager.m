...
//    return [self.masuContex previousMasuOfActiveCard:activeCenter];
//}
...
//        NSLog(@"index :%ld, previousIndex :%ld, targetIndex :%ld", (long)index, (long)previousIndex, (long)masu.masuIndex);
