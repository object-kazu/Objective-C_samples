...
-(void) MasuForSeven{
//    NSLog(@"mode 7");
    CGFloat width_7 = SCREEN_SIZE.height / 7;
    CGFloat height_7 = SCREEN_SIZE.width * 0.6;
    self.frame = CGRectMake(0, 0, width_7, height_7);
//    NSLog(@"Masu size is w:%f, h:%f",width_7,height_7);
...
//    NSLog(@"mode 14");
    CGFloat width_14 = SCREEN_SIZE.height / 7;
    CGFloat height_14 = SCREEN_SIZE.width * 0.4;
    self.frame = CGRectMake(0, 0, width_14, height_14);
//    NSLog(@"Masu size is w:%f, h:%f",width_14,height_14);
    self.masuWidth  = width_14;
}

-(void)MasuForTwentyOne{
//    NSLog(@"mode 21");
    CGFloat width_21 = SCREEN_SIZE.height / 7;
    CGFloat height_21 = SCREEN_SIZE.width * MASU_dy_FOR_Twentyone;
