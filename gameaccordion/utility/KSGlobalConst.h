...
//save data
DEFINE_GLOBAL_STRING(MODEDEFAULTS);
...
DEFINE_GLOBAL_STRING(BUTTON_SLIDE_LEFT);
DEFINE_GLOBAL_STRING(BUTTON_SLIDE_RIGHT);
...
#define SCREEN_HIGHT          SCREEN_BOUNDS.size.height

#define SCREEN_SIZE           (CGSizeMake(SCREEN_WIDTH, SCREEN_HIGHT))
#define LAND_SCREEN_SIZE      (CGSizeMake(SCREEN_SIZE.width, SCREEN_SIZE.height))
...
typedef NS_ENUM (NSInteger, GAME_LEVEL) {
    LEVEL_NORMAL = 0,
    LEVEL_EASY,
    LEVEL_VERY_EASY,
    LEVEL_MAX
