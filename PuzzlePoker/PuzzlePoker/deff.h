...
#define COLOR_SELECTED                    ([UIColor purpleColor])
...
#define MENU_width                        150 //button size
#define MENU_height                       45 //button size
...
#define LOYALSTRAIGHTFLASH                1000
#define STRAIGHTFLASH                     500
#define FLASHPAIR                         150
#define STRAIGHT                          100
#define PAIR                              50
#define FLASH                             5
